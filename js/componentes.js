        ...
        <ul class="nav-lista">
            ...
            <li class="nav-item tiene-dropdown">
                <a href="#" class="nav-link">
                    Páginas <span class="flecha">▾</span>
                </a>
                ...
                <ul class="dropdown">
                    ...
                    <li>
                        <a href="resumen.html">Resumen del curso</a>
                    </li>

                    <li>
                        <a href="instructor.html">Perfil del instructor</a>
                    </li>
                </ul>
            </li>
    ...
    <div class="container">
        ...
        <div class="footer-grid">
            ...
            <div>
                ...
                <ul>
                    <li>
                        <a href="instructor.html">Acerca de</a>
                    </li>
        ...
        <p class="footer-copy">
            &copy; SenaApp 2026. Todos los derechos reservados.
        </p>
...
document
    .querySelectorAll('.tiene-dropdown > .nav-link')
    .forEach(link => {
